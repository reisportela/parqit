...
> **Status:** v0.1.12 — the full surface below is implemented and covered by a
...
```stata
. net install parqit, from("https://github.com/reisportela/parqit/releases/download/v0.1.12") replace
...
- For a different version, change `v0.1.12` to the tag you want; for the newest, use
