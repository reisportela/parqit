...
> **Status:** v0.1.17 — the full surface below is implemented and covered by a
...
```stata
. net install parqit, from("https://github.com/reisportela/parqit/releases/download/v0.1.17") replace
